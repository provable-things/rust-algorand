...
const ALGORAND_MNEMONIC_CHECKSUM_NUM_BYTES: usize = 2;
...
impl AlgorandChecksum for AlgorandMnemonic {
    /// ## To Bytes
    ///
    ...
    fn get_checksum_num_bytes() -> usize {
        ALGORAND_MNEMONIC_CHECKSUM_NUM_BYTES
    }
...
impl AlgorandMnemonic {
    ...
    fn convert_u11_array_to_bytes(u11_bit_number_array: &[u32]) -> Bytes {
...
mod tests {
    ...
    fn should_convert_u11_array_to_words() {
        let u11_array = AlgorandMnemonic::convert_bytes_to_u11_array(&get_sample_32_bytes());
    ...
    fn should_convert_mnemonic_to_bytes() {
        ...
        assert_eq!(result, get_sample_32_bytes());
    }
    ...
    fn should_convert_bytes_to_u11_array() {
        ...
        let result = AlgorandMnemonic::convert_bytes_to_u11_array(&get_sample_32_bytes());
        assert_eq!(result, expected_result);
    }
